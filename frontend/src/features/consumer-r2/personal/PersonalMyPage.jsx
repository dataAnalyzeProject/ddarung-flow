...
export default function PersonalMyPage({ adapter = consumerPersonalAdapter, onNavigate, selectedStationId = null }) {
  ...
  // TS-ADMIN-MYPAGE-01: the console entry lives here, not in the header, and the click only
  // navigates — the server still decides who may actually enter /admin.
