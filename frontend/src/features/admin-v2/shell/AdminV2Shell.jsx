...
export default function AdminV2Shell({ consoles, activeConsole, activeRoute, access, allowedRouteIds = null, onConsoleSelect, onRouteNavigate, children, serviceHref = "/", showLogout = false, logoutAction = logout, navigateToLogin = browserLoginRedirect }) {
  ...
  return <div className="admin-v2-shell">
    ...
    <header className="admin-v2-header">
      ...
      <div className="admin-v2-header-context">
        ...
        <a className="admin-v2-service-link" href={serviceHref}>서비스 화면으로</a>
