...
export const getAdminPerformanceBase = () => request("/api/v1/admin/model-performance");
export const getAdminPerformanceDiagnostics = (artifactSha256) => request(`/api/v1/admin/model-performance/diagnostics?artifactSha256=${encodeURIComponent(artifactSha256)}`);
