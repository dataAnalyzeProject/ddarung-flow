...
function Dashboard({ data }) {
  return <>
    ...
    <div className="admin-dashboard-top">
      ...
      <Section title="운영 대기 항목" className="admin-pending-panel"><div className="admin-queue-list"><Queue icon="⇩" title="Export 요청 검토" detail="정거장 가용성 집계" badge="2건" /><Queue icon="◇" title="모델 승인 대기" detail="v16 검증 결과 확인" badge="1건" /><Queue icon="◌" title="Q&A 답변 대기" detail="예측 결과 카테고리" badge="1건" /></div></Section>
    </div>
